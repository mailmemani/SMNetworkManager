...
public typealias NetworkMonitorBlock =  ((Bool) -> Void)
public let NetworkReachableObserver = "NetworkReachableObserver"
...
open class ConnectionManager  {
    ...
    public func registerForNextworkMonitor(_ completionBlock: @escaping NetworkMonitorBlock) {
