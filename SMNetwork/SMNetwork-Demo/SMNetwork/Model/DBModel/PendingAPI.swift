...
internal class PendingAPI: NSManagedObject {
    ...
    public static func getPendingAPIs(predicate: NSPredicate?, sort : [NSSortDescriptor]?, context: NSManagedObjectContext) -> [PendingAPI]? {
    ...
    public static func deleteRecord(predicate: NSPredicate?, context: NSManagedObjectContext) {
